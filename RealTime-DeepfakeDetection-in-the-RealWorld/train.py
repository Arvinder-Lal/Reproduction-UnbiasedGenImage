...
if __name__ == '__main__':
    ...
    data_loader_train, train_paths = create_dataloader(opt)
    ...
    for epoch in range(opt.niter):
        ...
        # Validation
        model.eval()
#        acc, ap = validate(model.model, data_loader_val, val_opt)[:2]
        ...
        #Causes error: You must call wandb.init() before wandb.log()
